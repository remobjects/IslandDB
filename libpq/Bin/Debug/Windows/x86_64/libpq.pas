...
type
  ...
  private
    ...
    var u: __AnonymousType6; public;

  end;

  // Union
  __AnonymousType6 nested in libpq.PQArgBlock = public record
  private
  ...
  private
    ...
    class method PQresultAlloc(res: ^PGresult; nBytes: UInt64): ^Void; public;
    class method PQsetvalue(res: ^PGresult; tup_num: Int32; field_num: Int32; value: ^AnsiChar; len: Int32): Int32; public;
    class method PQescapeStringConn(conn: ^PGconn; &to: ^AnsiChar; &from: ^AnsiChar; length: UInt64; error: ^Int32): UInt64; public;
    class method PQescapeLiteral(conn: ^PGconn; str: ^AnsiChar; len: UInt64): ^AnsiChar; public;
    class method PQescapeIdentifier(conn: ^PGconn; str: ^AnsiChar; len: UInt64): ^AnsiChar; public;
    class method PQescapeByteaConn(conn: ^PGconn; &from: ^Byte; from_length: UInt64; to_length: ^UInt64): ^Byte; public;
    class method PQunescapeBytea(strtext: ^Byte; retbuflen: ^UInt64): ^Byte; public;
    class method PQescapeString(&to: ^AnsiChar; &from: ^AnsiChar; length: UInt64): UInt64; public;
    class method PQescapeBytea(&from: ^Byte; from_length: UInt64; to_length: ^UInt64): ^Byte; public;
    ...
    class method lo_read(conn: ^PGconn; fd: Int32; buf: ^AnsiChar; len: UInt64): Int32; public;
    class method lo_write(conn: ^PGconn; fd: Int32; buf: ^AnsiChar; len: UInt64): Int32; public;
    ...
    class method lo_truncate(conn: ^PGconn; fd: Int32; len: UInt64): Int32; public;

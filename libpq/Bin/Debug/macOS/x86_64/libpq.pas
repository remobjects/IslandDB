...
type
  ...
  private
    ...
    var u: __AnonymousType1; public;

  end;

  // Union
  __AnonymousType1 nested in libpq.PQArgBlock = public record
  private
  ...
  private
    ...
    class method PQresultAlloc(res: ^PGresult; nBytes: size_t): ^Void; public;
    class method PQsetvalue(res: ^PGresult; tup_num: Int32; field_num: Int32; value: ^AnsiChar; len: Int32): Int32; public;
    class method PQescapeStringConn(conn: ^PGconn; &to: ^AnsiChar; &from: ^AnsiChar; length: size_t; error: ^Int32): size_t; public;
    class method PQescapeLiteral(conn: ^PGconn; str: ^AnsiChar; len: size_t): ^AnsiChar; public;
    class method PQescapeIdentifier(conn: ^PGconn; str: ^AnsiChar; len: size_t): ^AnsiChar; public;
    class method PQescapeByteaConn(conn: ^PGconn; &from: ^Byte; from_length: size_t; to_length: ^size_t): ^Byte; public;
    class method PQunescapeBytea(strtext: ^Byte; retbuflen: ^size_t): ^Byte; public;
    class method PQescapeString(&to: ^AnsiChar; &from: ^AnsiChar; length: size_t): size_t; public;
    class method PQescapeBytea(&from: ^Byte; from_length: size_t; to_length: ^size_t): ^Byte; public;
    ...
    class method lo_read(conn: ^PGconn; fd: Int32; buf: ^AnsiChar; len: size_t): Int32; public;
    class method lo_write(conn: ^PGconn; fd: Int32; buf: ^AnsiChar; len: size_t): Int32; public;
    ...
    class method lo_truncate(conn: ^PGconn; fd: Int32; len: size_t): Int32; public;
    ...
    class var OID_MAX: Int64; public;
